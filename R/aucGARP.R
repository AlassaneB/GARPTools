...
#'
#' \code{aucGARP} Calculates the area under the ROC curve (AUC), which represents the accuracy of the subset of the best models produced by DesktopGARP. AUC evaluates the predictive performance of the
...
#'
#' @seealso \code{\link{zAUC}}, \code{\link{seAUC}}, \code{\link{wAUC}}, \code{\link{plotROC}}
#'
#' @examples
#'   set.seed(0)

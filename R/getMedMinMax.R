...
#' @param pathB a file path of the directory containing environmental layers used in DesktopGARP (must be in ESRI ASCII raster format)
#'
#' @return Returns a data.frame that contains the range, and median of the minimum and maximum values for each environment variable used in DesktopGARP.
#'

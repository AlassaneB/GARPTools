#' Calculates the Wilcoxon test statistic
#'
#' \code{wGARP} Returns the Wilcoxon test statistic of the best model subset output by DesktopGARP. When using discrete values, such as the number of models agreeing on predicted presence location, the Wilcoxon test statistic equates the AUC.
#'
...
#'
#' @return Returns the Wilcoxon test statistic.
#'
...
#'   wAUC(n = 10, x = r, points = SpatialPoints(hs[,1:2]))
#'
#' @import raster
#' @import sp
#'

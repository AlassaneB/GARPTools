...
#'
#' \code{plotRange} Plots the rescaled median ranges for environment variables used across dominant rules from a DesktopGARP experiment
#'
#' @param file a data.frame of the rescaled range, and the median of the minimum and maximum values for each environmental variables used in DesktopGARP. Produced by \code{\link{rescale}}

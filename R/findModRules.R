#' Pull rulesets created by DesktopGARP
#'
#' \code{findModRules} Gets the dominant rules produced by DesktopGARP which cover more than 90% of the landscape for the best subset models
#'
#' @param pathA file path to the directory for ruleset grids produced by DesktopGARP
#' @param pathB a vector object that contains the directories of the best subsets for each DesktopGARP experiment
#'

...
#'
#' \code{checkData} Checks that the training or testing points overlap environmental layers used with DesktopGARP.
#'
#' @param points a spatial object of the presence data used for training DesktopGARP, testing output models, or both training and testing points
#' @param grid a raster object of any environmental layer that will be input into DesktopGARP
#' @param mask optional; a spatial object of the study or sampling area
#'
#' @return If any point falls outside raster, will return error to resample or recrop raster to allow overlay. If all points fall within raster, will return message that data is okay to use in DesktopGARP.
#'

...
date: 'Last Updated: 4 November 2016'
...
files1 <- list.files(path=paste(system.file(package="GARPTools"),"/data", sep = ""),
                    pattern = ".rda", full.names = TRUE)
# files2 <- list.files(path=paste(system.file(package="GARPTools"),"/data", sep = ""),                     pattern = "task", full.names = TRUE)
...
<<<<<<< HEAD
# writeRaster(alt, "C:/GARP/rasters/alt.asc", overwrite = TRUE)
# writeRaster(bio_1, "C:/GARP/rasters/alt.asc", overwrite = TRUE)
# writeRaster(bio_12, "C:/GARP/rasters/alt.asc", overwrite = TRUE)
=======
writeRaster(alt, "C:/GARP/rasters/alt.asc", overwrite = TRUE)
writeRaster(bio_1, "C:/GARP/rasters/alt.asc", overwrite = TRUE)
writeRaster(bio_12, "C:/GARP/rasters/alt.asc", overwrite = TRUE)
>>>>>>> 842d4e96c7efe947d8e392bbc62c1d4732d11e95

# writeRaster(env_layers[[2]], "C:/GARP/rasters/bio_1.asc")
# writeRaster(env_layers[[3]], "C:/GARP/rasters/bio_12.asc")

env_layers <- stack(alt, bio_1,bio_12)
```
...
```{r comment = "R>", fig.height=2, fig.align = "center", fig.cap = "Three example environmental layers used in DesktopGARP experimental runs."}
...
```{r eval = TRUE, echo = FALSE}
files1 <- list.files(path=paste(system.file(package="GARPTools"),"/data", sep = ""), pattern = ".asc", full.names = TRUE)
files2 <- list.files(path=paste(system.file(package="GARPTools"),"/data", sep = ""), pattern = "task", full.names = TRUE)
files  <- files1[files1 %in% files2]
tasks <- stack(files)
...
```{r comment = "R>"}
commissionG(n = 10, x = r.sum, points = test.pts, file.path = "C:/GARP/BestSubsets/")
omissionG(n = 10, x = r.sum, points = test.pts)
```
